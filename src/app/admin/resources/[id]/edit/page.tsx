                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-xs text-muted-foreground flex items-center"><LucideIcons.Info className="w-3 h-3 mr-1" /> 若为Nginx原生托管应用，需以/结尾，如 <code className="ml-1 bg-slate-100 border text-slate-800 px-1 rounded">/periodic/</code></span>
                                </div>
                                <Input id="url" name="url" defaultValue={resource.url} placeholder="https:// 或 /periodic/" required />
                            </div>
                            <div className="space-y-2 md:col-span-2">
